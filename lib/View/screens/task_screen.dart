...
class TaskScreen extends StatelessWidget {
  ...
  final List<Task> tasks = [
    Task(
      ...
      taskTitle: "Wiring Dashboard Analytics",
      comment: 2,
    ...
    Task(
      priority: TaskPriority.High,
      status: TaskStatus.InProgress,
      taskTitle: "API Dashboard Analytics Integration",
      comment: 2,
      deadLine: DateTime.now(),
    ),
  ];

  // Builds task screen header
  Widget _buildHeader(){
    return ListTile(
      title: Text(
        "Challenges Awaiting",
