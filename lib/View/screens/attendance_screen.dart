...
class AttendanceScreen extends StatelessWidget {
        ...
        children: [
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [_buildWorkingHoursCard(context), _buildMapSection()],
              ),
            ),
          ),
        ],
          ...
          Row(
            ...
            children: [
              ...
              _getTimeCard(
                ...
                time: controller.getMonthlyDuration(),
              ),
            ],
          ),
         const SizedBox(height: 15),
          Align(
            ...
            child: SizedBox(
              ...
              child: _buildAttendanceButton(context),
            ),
          ),
        ],
      ),
  ...
  // Builds working hour summary card
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "${time} Hrs",
            style: TextStyle(fontSize: 20, color: kcBaseBlack),
          ),
        ],
      ),
    );
