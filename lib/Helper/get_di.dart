...
Future<void> init() async{
  ...
  Get.lazyPut(()=>ExpenseRepository(apiClient: Get.find<ApiClient>(), sharedPreferences: sharedPreferences), fenix: true);
  ...
  Get.lazyPut(()=>ExpenseController(expenseRepo: Get.find<ExpenseRepository>()), fenix: true);
